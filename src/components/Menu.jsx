...
export default function Menu({ onSelectPackage }) {
  ...
  return (
    <section id="menu" className="w-full pt-32 pb-24 sm:pt-36 sm:pb-28 relative overflow-hidden scroll-mt-16 bg-[#dc2626]">
      ...
      {/* Kanji Kanan: Kuning Amber Transparan */}
      ...
      {/* ================= 3. ORNAMEN ILUSTRASI JEPANG (MULTI-WARNA) ================= */}
      
      {/* Siluet Gurita (Kiri Atas) - Hitam Tipis */}
      <svg
      ...
      {/* Siluet Sumpit Silang (Kanan Atas) - Kuning Amber */}
      ...
      {/* Siluet Butir Takoyaki Berasap (Kiri Bawah) - Kuning Hangat */}
      <svg
      ...
      {/* Siluet Wajan Cetakan Takoyaki (Kanan Bawah) - Hitam Elegan */}
      <svg
